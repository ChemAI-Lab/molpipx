...
# File created from /gpfs/fs1/home/r/ravh011/ravh011/PIPMSA_jax/pipjax/msa_files/molecule_A4/MOL_4_8.MONO 
...
def f_monomials(r): 
    ...
    mono_88 = mono_2 * mono_64 
    mono_89 = mono_3 * mono_65 
    mono_90 = mono_4 * mono_66 
    mono_91 = mono_5 * mono_67 
    mono_92 = mono_1 * mono_68 
    mono_93 = mono_3 * mono_69 
    mono_94 = mono_4 * mono_70 
    mono_95 = mono_1 * mono_71 
    mono_96 = mono_2 * mono_72 
    mono_97 = mono_1 * mono_73 
    mono_98 = mono_2 * mono_74 
    mono_99 = mono_1 * mono_75 
    mono_100 = mono_2 * mono_76 
    mono_101 = mono_3 * mono_77 
    mono_102 = mono_3 * mono_78 
    mono_103 = mono_4 * mono_79 
    mono_104 = mono_4 * mono_80 
    mono_105 = mono_5 * mono_81 
    mono_106 = mono_5 * mono_82 
    mono_107 = mono_5 * mono_83 
    mono_108 = mono_6 * mono_84 
    mono_109 = mono_6 * mono_85 
    mono_110 = mono_6 * mono_86 
    mono_111 = mono_6 * mono_87 
