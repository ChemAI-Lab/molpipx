...
from pipjax.msa_files.molecule_A2B2C.monomials_MOL_2_2_1_8 import f_monomials as f_monos 


# File created from /gpfs/fs1/home/r/ravh011/ravh011/PIPMSA_jax/pipjax/msa_files/molecule_A2B2C/MOL_2_2_1_8.POLY 
...
def f_polynomials(r): 
    ...
    poly_4 = jnp.take(mono,6) + jnp.take(mono,7) + jnp.take(mono,8) + jnp.take(mono,9) 
    ...
    poly_11 = jnp.take(mono,13) + jnp.take(mono,14) + jnp.take(mono,15) + jnp.take(mono,16) 
    poly_12 = poly_1 * poly_4 - poly_11 
    poly_13 = poly_2 * poly_4 
    poly_14 = jnp.take(mono,17) + jnp.take(mono,18) + jnp.take(mono,19) + jnp.take(mono,20) 
    ...
    poly_26 = poly_4 * poly_4 - poly_18 - poly_16 - poly_15 - poly_18 - poly_16 - poly_15 
    ...
    poly_36 = jnp.take(mono,27) + jnp.take(mono,28) + jnp.take(mono,29) + jnp.take(mono,30) 
    ...
    poly_53 = jnp.take(mono,35) + jnp.take(mono,36) + jnp.take(mono,37) + jnp.take(mono,38) 
    ...
    poly_120 = jnp.take(mono,39) + jnp.take(mono,40) + jnp.take(mono,41) + jnp.take(mono,42) 
    ...
    poly_132 = jnp.take(mono,43) + jnp.take(mono,44) + jnp.take(mono,45) + jnp.take(mono,46) 
    poly_133 = poly_1 * poly_53 - poly_132 
    poly_134 = poly_2 * poly_53 
    poly_135 = jnp.take(mono,47) + jnp.take(mono,48) + jnp.take(mono,49) + jnp.take(mono,50) 
    ...
    poly_348 = jnp.take(mono,52) + jnp.take(mono,53) + jnp.take(mono,54) + jnp.take(mono,55) 
    ...
    poly_499 = jnp.take(mono,56) + jnp.take(mono,57) + jnp.take(mono,58) + jnp.take(mono,59) 
    ...
    poly_521 = jnp.take(mono,60) + jnp.take(mono,61) + jnp.take(mono,62) + jnp.take(mono,63) 
    ...
    poly_1080 = jnp.take(mono,64) + jnp.take(mono,65) + jnp.take(mono,66) + jnp.take(mono,67) 
    ...
    poly_1110 = jnp.take(mono,68) + jnp.take(mono,69) + jnp.take(mono,70) + jnp.take(mono,71) 
