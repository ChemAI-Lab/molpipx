...
# File created from /gpfs/fs1/home/r/ravh011/ravh011/PIPMSA_jax/pipjax/msa_files/molecule_A3BC/MOL_3_1_1_8.MONO 
...
def f_monomials(r): 
    ...
    mono_140 = mono_3 * mono_129 
    mono_141 = mono_2 * mono_131 
    mono_142 = mono_2 * mono_133 
    mono_143 = mono_7 * mono_110 
    mono_144 = mono_7 * mono_111 
    mono_145 = mono_6 * mono_112 
    mono_146 = mono_6 * mono_113 
    mono_147 = mono_5 * mono_114 
    mono_148 = mono_5 * mono_115 
    mono_149 = mono_4 * mono_122 
    mono_150 = mono_3 * mono_123 
    mono_151 = mono_4 * mono_124 
    mono_152 = mono_2 * mono_125 
    mono_153 = mono_3 * mono_126 
    mono_154 = mono_2 * mono_127 
    mono_155 = mono_6 * mono_129 
    mono_156 = mono_7 * mono_128 
    mono_157 = mono_5 * mono_131 
    mono_158 = mono_7 * mono_130 
    mono_159 = mono_5 * mono_133 
    mono_160 = mono_6 * mono_132 
    mono_161 = mono_7 * mono_143 
    mono_162 = mono_7 * mono_144 
    mono_163 = mono_6 * mono_145 
    mono_164 = mono_6 * mono_146 
    mono_165 = mono_5 * mono_147 
    mono_166 = mono_5 * mono_148 
    mono_167 = mono_4 * mono_149 
    mono_168 = mono_3 * mono_150 
    mono_169 = mono_4 * mono_151 
    mono_170 = mono_2 * mono_152 
    mono_171 = mono_3 * mono_153 
    mono_172 = mono_2 * mono_154 
    mono_173 = mono_7 * mono_161 
    mono_174 = mono_7 * mono_162 
    mono_175 = mono_6 * mono_163 
    mono_176 = mono_6 * mono_164 
    mono_177 = mono_5 * mono_165 
    mono_178 = mono_5 * mono_166 
    mono_179 = mono_4 * mono_167 
    mono_180 = mono_3 * mono_168 
    mono_181 = mono_4 * mono_169 
    mono_182 = mono_2 * mono_170 
    mono_183 = mono_3 * mono_171 
    mono_184 = mono_2 * mono_172 
...
#    stack all monomials 
    ...
    mono_181,    mono_182,    mono_183,    mono_184,    ]) 
