...
from pipjax.msa_files.molecule_A2B2.monomials_MOL_2_2_8 import f_monomials as f_monos 


# File created from /gpfs/fs1/home/r/ravh011/ravh011/PIPMSA_jax/pipjax/msa_files/molecule_A2B2/MOL_2_2_8.POLY 
...
def f_polynomials(r): 
    ...
    poly_2 = jnp.take(mono,2) + jnp.take(mono,3) + jnp.take(mono,4) + jnp.take(mono,5) 
    ...
    poly_16 = jnp.take(mono,13) + jnp.take(mono,14) + jnp.take(mono,15) + jnp.take(mono,16) 
