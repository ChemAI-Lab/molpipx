...
def train_and_evaluate_w_gradients(config: config_dict.ConfigDict,
    ...
    i0 = jnp.arange(n_tr, dtype=jnp.int32)
    i1 = jnp.arange(n_tr, n_tr + n_val, dtype=jnp.int32)
    ...
    X_tr, F_tr, y_tr = X_all[i0], F_all[i0], y_all[i0]
    X_val, F_val, y_val = X_all[i1], F_all[i1], y_all[i1]
