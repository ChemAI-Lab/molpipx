...
// File created from data/molecule_A3BC/MOL_3_1_1_8.MONO 
// Total number of monomials = 185 

pub const N_MONOS: usize = 185;
...
fn f_monomials2(mono: &mut [f64; N_MONOS]) { 
  ...
  mono[140] = mono[3] * mono[129];
  mono[141] = mono[2] * mono[131];
  mono[142] = mono[2] * mono[133];
  mono[143] = mono[7] * mono[110];
  mono[144] = mono[7] * mono[111];
  mono[145] = mono[6] * mono[112];
  mono[146] = mono[6] * mono[113];
  mono[147] = mono[5] * mono[114];
  mono[148] = mono[5] * mono[115];
  mono[149] = mono[4] * mono[122];
  mono[150] = mono[3] * mono[123];
  mono[151] = mono[4] * mono[124];
  mono[152] = mono[2] * mono[125];
  mono[153] = mono[3] * mono[126];
  mono[154] = mono[2] * mono[127];
  mono[155] = mono[6] * mono[129];
  mono[156] = mono[7] * mono[128];
  mono[157] = mono[5] * mono[131];
  mono[158] = mono[7] * mono[130];
  mono[159] = mono[5] * mono[133];
  mono[160] = mono[6] * mono[132];
}

fn f_monomials3(mono: &mut [f64; N_MONOS]) { 
  mono[161] = mono[7] * mono[143];
  mono[162] = mono[7] * mono[144];
  mono[163] = mono[6] * mono[145];
  mono[164] = mono[6] * mono[146];
  mono[165] = mono[5] * mono[147];
  mono[166] = mono[5] * mono[148];
  mono[167] = mono[4] * mono[149];
  mono[168] = mono[3] * mono[150];
  mono[169] = mono[4] * mono[151];
  mono[170] = mono[2] * mono[152];
  mono[171] = mono[3] * mono[153];
  mono[172] = mono[2] * mono[154];
  mono[173] = mono[7] * mono[161];
  mono[174] = mono[7] * mono[162];
  mono[175] = mono[6] * mono[163];
  mono[176] = mono[6] * mono[164];
  mono[177] = mono[5] * mono[165];
  mono[178] = mono[5] * mono[166];
  mono[179] = mono[4] * mono[167];
  mono[180] = mono[3] * mono[168];
  mono[181] = mono[4] * mono[169];
  mono[182] = mono[2] * mono[170];
  mono[183] = mono[3] * mono[171];
  mono[184] = mono[2] * mono[172];
}
